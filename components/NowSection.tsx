  ...
  return (
    <section>
        ...
        <p className='pb-4 flex'>Listening to
            <Image src={lisaRockstar} alt="" width={24} height={24} className='mx-2 rounded'/>
        ...
        <p className='pb-4 text-grey-500'>Reading
            <span className='group text-grey-800'>
                <span>&nbsp;</span>
                <span className='border-b-2 border-grey-300 hover:border-grey-800'>
                    <a href="https://noahkagan.com/mdwbook/" target="_blank" rel="noopener noreferrer">Million Dollar Weekend by Noah Kagan</a>
                </span>
                <span className='text-grey-400 group-hover:text-grey-800 font-medium'>&#x2197;</span>
            </span>
        </p>
        <p className='pb-8 text-grey-500'>Preparing for a <span className='text-grey-800'>road trip around Croatia, Bosnia, and Montenegro</span></p>

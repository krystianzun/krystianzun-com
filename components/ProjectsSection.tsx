    ...
    <section>
        ...
        <div className='pb-8'>
            <h1 className='group text-grey-800'>
                <span className='border-b-2 border-grey-300 hover:border-grey-800 font-medium'>XR Design Learning Roadmap</span>
        ...
        <div className='pb-8'>
            <h1 className='group text-grey-800'>
                <span className='border-b-2 border-grey-300 hover:border-grey-800 font-medium'>Design Futures</span>
                <span className='text-grey-400 group-hover:text-grey-800 font-medium'>&#x2197;</span>
            </h1>
        ...
        <div className='pb-8'>
            <h1 className='group text-grey-800'>
                <span className='border-b-2 border-grey-300 hover:border-grey-800 font-medium'>Touch Some Grass*</span>
                <span className='text-grey-400 group-hover:text-grey-800 font-medium'>&#x2197;</span>
            </h1>
